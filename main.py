...
def Creator():
    ...
    domains = ['gmail.com', 'yahoo.com', 'hotmail.com', 'hotmail.co.uk', 'hotmail.fr', 'outlook.com', 'icloud.com', 'mail.com', 'live.com', 'yahoo.it', 'yahoo.ca', 'yahoo.in', 'live.se', 'msn.com']
...
def logo():
    ...
    try:
        ...
        for l in msg:
            print(l, end="")
        print(Fore.RESET + "\t\t            Account Creator Remake by Dr. Teilaw ")
